import { type Root, Scope, NodeEditor, type BaseSchemes } from 'rete'
import { type Area2DInherited, type Area2D, AreaPlugin } from 'rete-area-plugin'
import type {  Point, Rect, Side } from '../../define'
import { getRectCenter } from '../path'
import { subscriber } from '../../tools/Subscriber'
import { screenToArea } from '../smoothZoom'
...
export class RectSelectPlugin extends Scope<never, Area2DInherited<BaseSchemes, never>> {
