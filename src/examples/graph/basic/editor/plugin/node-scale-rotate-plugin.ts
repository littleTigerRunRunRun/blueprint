...
import { areaToScreen, screenToArea } from '../tool/smoothZoom'
...
export type NodeScaleRotateContext = Area2D<Schemes> | Root<Schemes> | NodeScaleRotateEvent
...
export class NodeScaleRotatePlugin<S> extends Scope<NodeScaleRotateEvent, Area2DInherited<Schemes, NodeScaleRotateEvent>> {
