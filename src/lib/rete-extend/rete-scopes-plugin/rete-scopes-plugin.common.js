...
function getNodesBoundingBox(nodes, _ref) {
  ...
  var left = Math.min.apply(Math, _toConsumableArray__default["default"](boxes.map(function (b) {
    return b.position.x;
  })));
  var right = Math.max.apply(Math, _toConsumableArray__default["default"](boxes.map(function (b) {
    return b.position.x + b.width;
  })));
  var top = Math.min.apply(Math, _toConsumableArray__default["default"](boxes.map(function (b) {
    return b.position.y;
  })));
  var bottom = Math.max.apply(Math, _toConsumableArray__default["default"](boxes.map(function (b) {
...
var ScopesPlugin = /*#__PURE__*/function (_Scope) {
  function ScopesPlugin(props) {
    var _this;
    _classCallCheck__default["default"](this, ScopesPlugin);
...
exports.ScopesPlugin = ScopesPlugin;
exports.getPickedNodes = getPickedNodes;
//# sourceMappingURL=rete-scopes-plugin.common.js.map
