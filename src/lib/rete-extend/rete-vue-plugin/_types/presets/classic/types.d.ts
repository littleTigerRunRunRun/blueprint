...
export type VueArea2D<T extends ClassicScheme> = RenderSignal<'node', {
    payload: T['Node'];
...
export type ExtractPayload<T extends ClassicScheme, K extends string> = Extract<VueArea2D<T>, {
    type: 'render';
    data: {
        type: K;
    };
