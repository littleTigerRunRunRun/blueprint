...
function create(element, component, payload, onRendered, props) {
  ...
  var app = props !== null && props !== void 0 && props.setup ? props.setup(context) : new Vue__default["default"](context);
  app.payload = payload;
...
var render$d = function render(){var _vm=this,_c=_vm._self._c;return _c('svg',{attrs:{"data-testid":"connection"}},[_c('path',{attrs:{"d":_vm.path}})])
};
...
__component__$e.options.__file = "C:\\Users\\Administrator\\Desktop\\vue-plugin\\src\\presets\\classic\\components\\Connection.vue";
var Connection = __component__$e.exports;

var render$c = function render(){var _vm=this,_c=_vm._self._c;return _c(_vm.component,{tag:"component",attrs:{"data":_vm.data,"start":_vm.startPosition,"end":_vm.endPosition,"path":_vm.observedPath}})
};
...
__component__$d.options.__file = "C:\\Users\\Administrator\\Desktop\\vue-plugin\\src\\presets\\classic\\components\\ConnectionWrapper.vue";
var ConnectionWrapper = __component__$d.exports;

var render$b = function render(){var _vm=this,_c=_vm._self._c;return _c('input',{attrs:{"type":_vm.data.type,"readonly":_vm.data.readonly},domProps:{"value":_vm.data.value},on:{"input":_vm.change,"pointerdown":function($event){$event.stopPropagation();}}})
};
...
__component__$c.options.__file = "C:\\Users\\Administrator\\Desktop\\vue-plugin\\src\\presets\\classic\\components\\Control.vue";
var Control = __component__$c.exports;

var render$a = function render(){var _vm=this,_c=_vm._self._c;return _c('div',_vm._b({ref:"element"},'div',_vm.$props,false))
};
...
__component__$b.options.__file = "C:\\Users\\Administrator\\Desktop\\vue-plugin\\src\\Ref.vue";
...
__component__$a.options.__file = "C:\\Users\\Administrator\\Desktop\\vue-plugin\\src\\presets\\classic\\components\\Node.vue";
var Node = __component__$a.exports;

var render$8 = function render(){var _vm=this,_c=_vm._self._c;return _c('div',{staticClass:"socket",attrs:{"title":_vm.data.name}})
};
...
__component__$9.options.__file = "C:\\Users\\Administrator\\Desktop\\vue-plugin\\src\\presets\\classic\\components\\Socket.vue";
...
var render$7 = function render(){var _vm=this,_c=_vm._self._c;return _c('div',{staticClass:"block"},[_vm._t("default")],2)
};
...
__component__$8.options.__file = "C:\\Users\\Administrator\\Desktop\\vue-plugin\\src\\presets\\context-menu\\components\\Block.vue";
var Block = __component__$8.exports;

var render$6 = function render(){var _vm=this,_c=_vm._self._c;return _c('input',{staticClass:"search",attrs:{"data-testid":"context-menu-search-input"},domProps:{"value":_vm.text},on:{"input":function($event){return _vm.$emit('change', $event.target.value)}}})
};
...
__component__$7.options.__file = "C:\\Users\\Administrator\\Desktop\\vue-plugin\\src\\presets\\context-menu\\components\\Search.vue";
...
__component__$6.options.__file = "C:\\Users\\Administrator\\Desktop\\vue-plugin\\src\\presets\\context-menu\\components\\Item.vue";
...
var _sfc_render = function render(){var _vm=this,_c=_vm._self._c;return _c('div',{staticClass:"menu",class:[_vm.className ? _vm.className : ''],attrs:{"data-testid":"context-menu","rete-context-menu":""},on:{"mouseover":function($event){return _vm.hide.cancel()},"mouseleave":function($event){return _vm.hide.call()}}},[(_vm.searchBar)?_c('Block',[_c('Search',{attrs:{"text":_vm.filter},on:{"change":function($event){_vm.filter = $event;}}})],1):_vm._e(),_vm._l((_vm.getItems()),function(item){return _c('Item',{key:item.key,attrs:{"delay":_vm.delay,"subitems":item.subitems},on:{"select":function($event){return item.handler($event)},"hide":function($event){return _vm.onHide()}}},[_vm._v(" "+_vm._s(item.label)+" ")])})],2)
};
...
__component__$5.options.__file = "C:\\Users\\Administrator\\Desktop\\vue-plugin\\src\\presets\\context-menu\\components\\Menu.vue";
...
__component__$4.options.__file = "C:\\Users\\Administrator\\Desktop\\vue-plugin\\src\\presets\\minimap\\MiniNode.vue";
...
__component__$3.options.__file = "C:\\Users\\Administrator\\Desktop\\vue-plugin\\src\\presets\\minimap\\MiniViewport.vue";
...
__component__$2.options.__file = "C:\\Users\\Administrator\\Desktop\\vue-plugin\\src\\presets\\minimap\\Minimap.vue";
...
__component__$1.options.__file = "C:\\Users\\Administrator\\Desktop\\vue-plugin\\src\\presets\\reroute\\Pin.vue";
...
__component__.options.__file = "C:\\Users\\Administrator\\Desktop\\vue-plugin\\src\\presets\\reroute\\Pins.vue";
...
var VuePlugin = /*#__PURE__*/function (_Scope) {
  function VuePlugin(props) {
    ...
    _defineProperty__default["default"](_this, "owners", new WeakMap());
  ...
  return _createClass__default["default"](VuePlugin, [{
    key: "setParent",
