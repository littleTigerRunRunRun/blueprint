...
function create(element, component, payload, onRendered, props) {
  var state = vue.ref(vue.markRaw(payload));
  var context = {
    render: function render() {
      // @ts-ignore
      return vue.h(component, _objectSpread$4(_objectSpread$4({}, state.value), {}, {
        seed: Math.random()
      }));
    },
  ...
  var app = props !== null && props !== void 0 && props.setup ? props.setup(context) : vue.createApp(context);
  app.mount(element);
  return {
    app: app,
    payload: state
...
function update(instance, payload) {
  instance.payload.value = vue.markRaw(_objectSpread$4(_objectSpread$4({}, instance.payload.value), payload));
}
...
function render$d(_ctx, _cache, $props, $setup, $data, $options) {
  return (vue.openBlock(), vue.createElementBlock("svg", _hoisted_1$7, [
    vue.createElementVNode("path", { d: $props.path }, null, 8 /* PROPS */, _hoisted_2$1)
  ]))
}
...
function render$c(_ctx, _cache, $props, $setup, $data, $options) {
  return (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.component), {
    data: $props.data,
...
function render$b(_ctx, _cache, $props, $setup, $data, $options) {
  return (vue.openBlock(), vue.createElementBlock("input", {
    ...
    onPointerdown: _cache[1] || (_cache[1] = vue.withModifiers(() => {}, ["stop"]))
...
function render$a(_ctx, _cache, $props, $setup, $data, $options) {
  return (vue.openBlock(), vue.createElementBlock("div", vue.mergeProps(_ctx.$props, { ref: "element" }), null, 16 /* FULL_PROPS */))
}
...
function render$9(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_Ref = vue.resolveComponent("Ref");

  return (vue.openBlock(), vue.createElementBlock("div", {
    class: vue.normalizeClass(["node", { selected: $props.data.selected }]),
    style: vue.normalizeStyle($options.nodeStyles()),
    "data-testid": "node"
  }, [
    vue.createElementVNode("div", _hoisted_1$5, vue.toDisplayString($props.data.label), 1 /* TEXT */),
    vue.createCommentVNode(" Outputs"),
    (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($options.outputs(), ([key, output]) => {
      return (vue.openBlock(), vue.createElementBlock("div", {
        class: "output",
        key: 'output' + key + $props.seed,
        "data-testid": 'output-'+key
      }, [
        vue.createElementVNode("div", _hoisted_3, vue.toDisplayString(output.label), 1 /* TEXT */),
        vue.createVNode(_component_Ref, {
          class: "output-socket",
    ...
    (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($options.controls(), ([key, control]) => {
      return (vue.openBlock(), vue.createBlock(_component_Ref, {
        class: "control",
    ...
    (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($options.inputs(), ([key, input]) => {
      return (vue.openBlock(), vue.createElementBlock("div", {
        class: "input",
        ...
        }, vue.toDisplayString(input.label), 513 /* TEXT, NEED_PATCH */), [
          [vue.vShow, !input.control || !input.showControl]
        ]),
        vue.withDirectives(vue.createVNode(_component_Ref, {
          class: "input-control",
          emit: $props.emit,
  ...
  return (vue.openBlock(), vue.createBlock(_component_Block, {
    ...
    default: vue.withCtx(() => [
      vue.createElementVNode("div", {
        class: "content",
        onClick: _cache[1] || (_cache[1] = vue.withModifiers($event => {_ctx.$emit('select', $event); _ctx.$emit('hide');}, ["stop"])),
        onWheel: _cache[2] || (_cache[2] = vue.withModifiers(() => {}, ["stop"])),
        ...
        onPointerdown: _cache[5] || (_cache[5] = vue.withModifiers(() => {}, ["stop"]))
      }, [
        vue.renderSlot(_ctx.$slots, "default", {}, undefined, true),
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (vue.openBlock(), vue.createElementBlock("div", {
    class: vue.normalizeClass(["menu", [$props.className ? $props.className : '']]),
    ...
    ($props.searchBar)
      ? (vue.openBlock(), vue.createBlock(_component_Block, { key: 0 }, {
          default: vue.withCtx(() => [
      ...
      : vue.createCommentVNode("v-if", true),
    (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($options.getItems(), (item) => {
      return (vue.openBlock(), vue.createBlock(_component_Item, {
        key: item.key,
        onSelect: $event => (item.handler($event)),
        delay: $props.delay,
...
function render$4(_ctx, _cache, $props, $setup, $data, $options) {
  return (vue.openBlock(), vue.createElementBlock("div", {
    class: "mini-node",
    style: vue.normalizeStyle($options.styles),
...
function render$3(_ctx, _cache, $props, $setup, $data, $options) {
  return (vue.openBlock(), vue.createElementBlock("div", {
    class: "mini-viewport",
    onPointerdown: _cache[0] || (_cache[0] = vue.withModifiers($event => ($data.drag.start($event)), ["stop"])),
    style: vue.normalizeStyle($options.styles),
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_MiniNode = vue.resolveComponent("MiniNode");
  const _component_MiniViewport = vue.resolveComponent("MiniViewport");

  return (vue.openBlock(), vue.createElementBlock("div", {
    class: "minimap",
    ref: "container",
    style: vue.normalizeStyle({ width: $options.px($props.size * $props.ratio), height: $options.px($props.size) }),
    onPointerdown: _cache[0] || (_cache[0] = vue.withModifiers(() => {}, ["stop","prevent"])),
    onDblclick: _cache[1] || (_cache[1] = vue.withModifiers($event => ($options.dblclick($event)), ["stop","prevent"])),
    "data-testid": "minimap"
  }, [
    (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($props.nodes, (node, index) => {
      return (vue.openBlock(), vue.createBlock(_component_MiniNode, {
    ...
    vue.createVNode(_component_MiniViewport, {
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return (vue.openBlock(), vue.createElementBlock("div", {
    class: vue.normalizeClass(["pin", { selected: $props.selected }]),
    onPointerdown: _cache[0] || (_cache[0] = vue.withModifiers($event => {$data.drag.start($event); _ctx.$emit('down');}, ["stop","prevent"])),
    onContextmenu: _cache[1] || (_cache[1] = vue.withModifiers($event => (_ctx.$emit('menu')), ["stop","prevent"])),
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_Pin = vue.resolveComponent("Pin");

  return (vue.openBlock(), vue.createElementBlock("div", _hoisted_1, [
    (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($props.pins, (pin) => {
      return (vue.openBlock(), vue.createBlock(_component_Pin, {
        key: pin.id,
